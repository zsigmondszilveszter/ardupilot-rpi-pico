...
void RCInput::open_sbus()
{
    ...
    rc_rx_uart_pio_program_init(_pio, _sm, offset, RP2xxx_RC_RX_PIN, SBUS_BAUD, SBUS);
}
...
void RCInput::open_ibus()
{
    ...
    rc_rx_uart_pio_program_init(_pio, _sm, offset, RP2xxx_RC_RX_PIN, IBUS_BAUD, IBUS);
}
...
#endif //#if CONFIG_HAL_BOARD == HAL_BOARD_RP2xxxCHIBIOS
