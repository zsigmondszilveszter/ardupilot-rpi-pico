...
#define MAX_UART_TX_FIFO_SIZE (RP2xxx_UART_TX_FIFO_SIZE <= RP2xxx_UART_MAX_ALLOWED_BUFFER_SIZE ? RP2xxx_UART_TX_FIFO_SIZE : RP2xxx_UART_MAX_ALLOWED_BUFFER_SIZE)
#define MAX_UART_RX_FIFO_SIZE (RP2xxx_UART_RX_FIFO_SIZE <= RP2xxx_UART_MAX_ALLOWED_BUFFER_SIZE ? RP2xxx_UART_RX_FIFO_SIZE : RP2xxx_UART_MAX_ALLOWED_BUFFER_SIZE)
