...
#define RP2040_STORAGE_LINE_SHIFT   9
#define RP2040_STORAGE_LINE_SIZE    (1<<RP2040_STORAGE_LINE_SHIFT)
#define RP2040_STORAGE_NUM_LINES    (HAL_STORAGE_SIZE/RP2040_STORAGE_LINE_SIZE)
...
private:
    ...
    HAL_Semaphore sem;
    uint8_t tmpline[RP2040_STORAGE_LINE_SIZE];
